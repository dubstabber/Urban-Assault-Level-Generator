...
TYP_BEAM_GATE_NO_ROAD = 0x03
TYP_BEAM_GATE_WITH_ROAD = 0xCA
TYP_GATE_CLOSED_1 = 0xF4
TYP_GATE_CLOSED_2 = 0xF3
TYP_BOMB_STANDARD = 0xF5
TYP_SUPERITEM = 0xF5
TYP_TILESET6_BOMB = 0xEB

STANDARD_BOMB_BLUEPRINTS = (35, 36, 37)
TILESET6_BOMB_BLUEPRINTS = (68, 69, 70)
TILESET6_BOMB_CORNER_TYP_BY_OFFSET = {
    (-1, -1): 0xE9,
    (1, -1): 0xEA,
    (-1, 1): 0xE8,
    (1, 1): 0xE7,
}
TILESET6_BOMB_DIAGONAL_KEY_TYP_BY_OFFSET = TILESET6_BOMB_CORNER_TYP_BY_OFFSET
...
GENERATOR4_CAMPAIGN_PROFILES = _PROFILE_REGISTRY.names("generator4")
