...
class Generator4Renderer:
    def write(self, level: _Gen4Level) -> str:
    ...
    def _write_header(self, writer: LDFWriter, level: _Gen4Level) -> None:
        writer.line(";#*+ don't edit the magic runes")
        writer.line("")
        writer.line(";------------------------------------------------------------")
        writer.line(";--- Generated by Urban Assault Level Generator           ---")
        writer.line(";--- Generator: Generator4 (Campaign-Aware Synthesis)    ---")
        writer.line(";------------------------------------------------------------")
        writer.line(f";--- Seed: {level.seed}")
        writer.line(f";--- Archetype: {level.archetype.name} ({level.source})")
        writer.line(f";--- Synthesized terrain ({level.synth_method})")
        ...
        writer.property("title_default", level.header.get("title_default", level.title or "GENERATOR4"))
