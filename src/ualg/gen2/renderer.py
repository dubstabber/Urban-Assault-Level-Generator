...
_CAMPAIGN_ENABLE_EXCLUDED_VEHICLE_IDS = ENABLE_EXCLUDED_VEHICLE_IDS
_MD_TAERKASTEN_ENABLE_EXCLUDED_FACTIONS = {"tae", "bla"}
_MD_TAERKASTEN_ENABLE_EXCLUDED_VEHICLE_IDS = MD_TAERKASTEN_ENABLE_EXCLUDED_VEHICLE_IDS
